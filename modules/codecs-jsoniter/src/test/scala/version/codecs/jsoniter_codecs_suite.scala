...
class JsoniterCodecsSuite extends munit.FunSuite:
  ...
  test("Jsoniter encoding of MajorVersion instances") {
    def validString = "1"
    assertEquals(writeToString(MajorVersion.fromUnsafe(1)), validString)
  }

  test("Jsoniter decoding of Minor instances") {
    val validMajorVersion1 = "1" -> MinorVersion.fromUnsafe(1)
    val invalidVersionNumber = "-1"
  ...
  test("Jsoniter encoding of MinorVersion instances") {
    def validString = "1"
    assertEquals(writeToString(MinorVersion.fromUnsafe(1)), validString)
  }

  test("Jsoniter decoding of PatchNumber instances") {
    val validMajorVersion1 = "1" -> PatchNumber.fromUnsafe(1)
    val invalidVersionNumber = "-1"
  ...
  test("Jsoniter encoding of PatchNumber instances") {
    def validString = "1"
    assertEquals(writeToString(PatchNumber.fromUnsafe(1)), validString)
  }

  test("Jsoniter decoding of PreReleaseNumber instances") {
    val validMajorVersion1 = "1" -> PreReleaseNumber.fromUnsafe(1)
    val invalidVersionNumber = "-1"
  ...
  test("Jsoniter encoding of PreReleaseNumber instances") {
    def validString = "1"
    assertEquals(writeToString(PreReleaseNumber.fromUnsafe(1)), validString)
  }
